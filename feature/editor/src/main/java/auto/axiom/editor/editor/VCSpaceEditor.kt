...
package auto.axiom.editor.editor

import android.content.Context
import android.graphics.Rect
import android.util.AttributeSet
import android.view.inputmethod.EditorInfo
import auto.axiom.editor.editor.completion.CompletionListAdapter
import auto.axiom.editor.editor.completion.CustomCompletionLayout
...
class AxiomEditorEditor @JvmOverloads constructor(
    context: Context,
    ...
    fun setTextActionWindow(window: (AxiomEditorEditor) -> TextActionsWindow) {
