...
package auto.axiom.editor.ui.screens.plugin.components
...
import auto.axiom.editor.file.DocumentFileWrapper
...
import auto.axiom.editor.ui.rememberSheetState
import java.io.File
...
fun NewPluginSheet(
    ...
    val defaultDescription = "A sample plugin for AxiomEditor"
