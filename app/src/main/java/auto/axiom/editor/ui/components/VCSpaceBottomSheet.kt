...
package auto.axiom.editor.ui.components
...
@Composable
fun AxiomEditorBottomSheet(
    modifier: Modifier = Modifier
) {
    AxiomEditorTheme {
        Box(modifier) {
            Text(text = "AxiomEditorBottomSheet")
        }
    }
}

@Preview(name = "AxiomEditorBottomSheet")
@Composable
private fun PreviewAxiomEditorBottomSheet() {
    AxiomEditorBottomSheet()
}