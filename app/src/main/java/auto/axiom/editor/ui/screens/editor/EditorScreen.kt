...
import auto.axiom.editor.activities.Editor.LocalEditorSnackbarHostState
...
import auto.axiom.editor.core.settings.Settings.Editor.rememberUseTab
import auto.axiom.editor.core.settings.Settings.Editor.rememberWordWrap
import auto.axiom.editor.core.settings.Settings.File.rememberLastOpenedFile
import auto.axiom.editor.core.settings.Settings.General.rememberFollowSystemTheme
import auto.axiom.editor.core.settings.Settings.General.rememberIsDarkMode
import auto.axiom.editor.core.settings.Settings.Monaco
import auto.axiom.editor.core.settings.Settings.Monaco.rememberAcceptSuggestionOnCommitCharacter
import auto.axiom.editor.core.settings.Settings.Monaco.rememberAcceptSuggestionOnEnter
import auto.axiom.editor.core.settings.Settings.Monaco.rememberCursorBlinkingStyle
import auto.axiom.editor.core.settings.Settings.Monaco.rememberCursorStyle
import auto.axiom.editor.core.settings.Settings.Monaco.rememberFolding
import auto.axiom.editor.core.settings.Settings.Monaco.rememberGlyphMargin
import auto.axiom.editor.core.settings.Settings.Monaco.rememberLetterSpacing
import auto.axiom.editor.core.settings.Settings.Monaco.rememberLineDecorationsWidth
import auto.axiom.editor.core.settings.Settings.Monaco.rememberLineNumbersMinChars
import auto.axiom.editor.core.settings.Settings.Monaco.rememberMatchBrackets
import auto.axiom.editor.core.settings.Settings.Monaco.rememberMonacoTheme
import auto.axiom.editor.core.settings.Settings.Monaco.rememberWordBreak
import auto.axiom.editor.core.settings.Settings.Monaco.rememberWrappingStrategy
import auto.axiom.editor.editor.TextActionsWindow
import auto.axiom.editor.editor.AxiomEditorEditor
import auto.axiom.editor.editor.addBlockComment
import auto.axiom.editor.editor.addSingleComment
import auto.axiom.editor.editor.listener.OnExplainCodeListener
import auto.axiom.editor.editor.listener.OnImportComponentListener
import auto.axiom.editor.editor.textaction.EditorTextActionItem
import auto.axiom.editor.editor.textaction.actionItems
import auto.axiom.editor.editor.textaction.editorTextActionWindow
...
import auto.axiom.editor.keyboard.createKeyEvent
import auto.axiom.editor.keyboard.model.toShortcut
import auto.axiom.editor.plugins.DialogManager
import auto.axiom.editor.resources.R
import auto.axiom.editor.ui.LocalToastHostState
import auto.axiom.editor.ui.components.keyboard.CommandPalette
import auto.axiom.editor.ui.screens.editor.ai.CodeExplanationSheet
import auto.axiom.editor.ui.screens.editor.ai.ImportComponentsSheet
import auto.axiom.editor.ui.screens.editor.components.Symbols
...
import com.axiomeditor.plugins.event.KeyPressEvent
...
@Composable
private fun ConfigureFontSettings(editor: AxiomEditorEditor) {
...
@Composable
private fun ConfigureColorScheme(editor: AxiomEditorEditor) {
...
@Composable
private fun ConfigureIndentation(editor: AxiomEditorEditor) {
...
@Composable
private fun ConfigureMiscSettings(editor: AxiomEditorEditor) {
