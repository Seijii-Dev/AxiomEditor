...
import auto.axiom.editor.activities.CrashActivity
import auto.axiom.editor.core.EventManager
import auto.axiom.editor.extensions.doIfNull
...
class AxiomEditorApplication : BaseApplication() {
    ...
    companion object {
        ...
        private const val TAG = "AxiomEditorApplication"

        private var appInstance: AxiomEditorApplication? = null

        init {
            System.loadLibrary("axiomeditor")
        }

        @JvmStatic
        @Synchronized
        fun getInstance(): AxiomEditorApplication {
            doIfNull(appInstance) {
                appInstance = AxiomEditorApplication()
            }
