...
public class AxiomEditorTMSymbolPairMatch extends SymbolPairMatch {
  ...
  public AxiomEditorTMSymbolPairMatch(AxiomEditorTMLanguage language) {
  ...
  public void updatePair() {
    ...
    for (var pair : mergePairs) {
      putPair(pair.open, new SymbolPair(pair.open, pair.close, new AxiomEditorTMSymbolPairMatch.SymbolPairEx(pair)));
    }
  }
