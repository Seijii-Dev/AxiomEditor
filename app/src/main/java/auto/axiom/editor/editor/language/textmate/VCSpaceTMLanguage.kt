...
class AxiomEditorTMLanguage protected constructor(
    ...
    var symbolPairMatch: AxiomEditorTMSymbolPairMatch = AxiomEditorTMSymbolPairMatch(this)

    var newlineHandler: AxiomEditorTMNewlineHandler? = null
        private set
    ...
    private fun createAnalyzerAndNewlineHandler(
        ...
        newlineHandler = AxiomEditorTMNewlineHandler(this)
    ...
    override fun getAnalyzeManager(): AnalyzeManager {
        ...
        return textMateAnalyzer as AxiomEditorTMAnalyzer
    }
    ...
    override fun getSymbolPairs(): AxiomEditorTMSymbolPairMatch {
...
//          }.onFailure(Throwable::printStackTrace)
    ...
    companion object {
        ...
        fun create(
            ...
            languageConfiguration: Reader?,
            themeSource: IThemeSource?
        ): AxiomEditorTMLanguage {
            val grammar = prepareLoad(grammarSource, languageConfiguration, themeSource)
            return create(grammar.scopeName, true)
        }

        @Deprecated("")
        fun create(grammarSource: IGrammarSource, themeSource: IThemeSource?): AxiomEditorTMLanguage {
        ...
        fun create(languageScopeName: String?, autoCompleteEnabled: Boolean): AxiomEditorTMLanguage {
