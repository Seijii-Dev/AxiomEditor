...
import auto.axiom.editor.activities.EditorActivity
import auto.axiom.editor.app.rootView
import auto.axiom.editor.core.EventManager
import auto.axiom.editor.core.MenuManager
import auto.axiom.editor.core.PanelManager
import auto.axiom.editor.core.components.DraggableFloatingPanel
...
import com.axiomeditor.plugins.editor.Position
import com.axiomeditor.plugins.event.EventListener
import com.axiomeditor.plugins.event.EventType
import com.axiomeditor.plugins.menu.MenuItem
import com.axiomeditor.plugins.network.HttpResponse
import com.axiomeditor.plugins.panel.ComposeFactory
import com.axiomeditor.plugins.panel.Panel
import com.axiomeditor.plugins.panel.ViewFactory
import com.axiomeditor.plugins.panel.ViewUpdater
...
class PluginContextImpl(
    ...
    override fun addMenu(menuItem: MenuItem) {
        ...
        menuManager.addMenu(
            auto.axiom.editor.core.menu.MenuItem(
                menuItem.title,
                menuItem.id,
                visible = true,
                enabled = true,
    ...
    private inner class EditorListener : EditorImpl.Listener {
        ...
        override val editor: AxiomEditorEditor?
