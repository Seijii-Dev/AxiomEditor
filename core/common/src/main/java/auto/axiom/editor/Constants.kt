...
val APP_EXTERNAL_DIR = "${PathUtils.getExternalStoragePath()}/AxiomEditor"

const val ORGANIZATION_NAME = "Axiom-Editor"
const val APPLICATION_REPOSITORY_NAME = "Axiom-Editor"
